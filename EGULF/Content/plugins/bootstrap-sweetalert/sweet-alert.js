  ...
  window.sweetAlert = window.swal = function() {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'string':
        ...
        params.confirmButtonClass = params.type ? 'btn-' + (params.type == 'error'? 'danger' : params.type ): defaultParams.confirmButtonClass;
      ...
      case 'object':
        ...
        params.confirmButtonClass = arguments[0].confirmButtonClass || (arguments[0].type ? 'btn-' + (params.type == 'error' ? 'danger' : arguments[0].type) : null) || defaultParams.confirmButtonClass;
